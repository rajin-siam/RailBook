    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainServices", x => x.ServiceId);
                    table.ForeignKey(
                        name: "FK_TrainServices_Passengers_PassengerId",
                        column: x => x.PassengerId,
                        principalTable: "Passengers",
                        principalColumn: "PassengerId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainServices_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Passengers_CreatedBy",
                table: "Passengers",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TrainServices_CreatedBy",
                table: "TrainServices",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TrainServices_PassengerId",
                table: "TrainServices",
                column: "PassengerId");
        }
